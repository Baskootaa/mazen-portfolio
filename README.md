# Mazen Albasyouny — Developer Portfolio Website
...
- **PHP IDE Mock Editor Window**: An interactive, syntax-highlighted code editor mockup representing developer credentials.
...
- **Styling & Layout**: CSS3 — modularized per feature (`css/base.css`, `css/hero.css`, `css/about.css`, `css/effects-hacker.css`, `css/responsive.css`, etc.), vanilla grids, flexbox, variables, keyframe animations.
- **Interactive Logic**: Vanilla JavaScript (ES6+, IntersectionObserver API, HTML5 Canvas API) — modularized per feature (`js/terminal-console.js`, `js/command-palette.js`, `js/github.js`, `js/reactions.js`, etc.)
...
- **Fonts & Icons**: Google Fonts (Outfit, JetBrains Mono), Devicons CDN.
...
├── css/ # Modular stylesheets (base, hero, about, sections, effects, responsive, etc.)
├── js/ # Modular client scripts (terminal, command palette, effects, etc.)
...
This project is created by Mazen Albasyouny as a personal developer portfolio. Feel free to explore the code for reference and learning purposes.
