...
console.log('%c 🚀 Mazen Albasyouny Portfolio ', 'background:#ffffff;color:#050505;font-size:16px;padding:8px 16px;border-radius:8px;font-weight:bold;');
...
(function () {
  ...
  const emailText = 'mazen01289elbasyouny@gmail.com';
