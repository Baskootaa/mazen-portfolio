...
(function () {
  ...
  const commands = [
    ...
    { group: 'Navigate', icon: svgFolder, label: 'Go to Projects', keywords: 'projects work blood bank gym', action: () => scrollTo('#projects') },
    { group: 'Navigate', icon: svgBriefcase, label: 'Go to Experience', keywords: 'experience internship nti training', action: () => scrollTo('#experience') },
    { group: 'Navigate', icon: svgCode, label: 'Go to Skills', keywords: 'skills stack tech php laravel', action: () => scrollTo('#skills') },
    { group: 'Navigate', icon: svgAward, label: 'Go to Education & Certs', keywords: 'education certifications mansoura university journey', action: () => scrollTo('#education') },
    ...
    { group: 'Links', icon: svgGh, label: 'Open GitHub Profile', keywords: 'github profile baskootaa', action: () => window.open('https://github.com/Baskootaa', '_blank'), hint: '↗' },
    { group: 'Links', icon: svgExternal, label: 'Open LinkedIn Profile', keywords: 'linkedin connect mazen albasyouny', action: () => window.open('https://www.linkedin.com/in/mazen-albasyouny', '_blank'), hint: '↗' },
  ];
